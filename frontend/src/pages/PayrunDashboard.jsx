...
const PayrunDashboard = () => {
  ...
  const handleEmployeeSelectForCompute = (e) => {
    ...
    if (employee) {
      ...
      const existingPayslip = payrunData.payslips.find(p => p.employee_id === empId);
  ...
  const handleComputeInModal = () => {
    ...
    const earnedDays = (selectedEmployeeForCompute.present_days || 0) + (selectedEmployeeForCompute.paid_leaves || 0);
    ...
    const unpaidDeduction = perDayRate * (selectedEmployeeForCompute.unpaid_leaves || 0);
  ...
  const handleComputeNewPayslip = () => {
    const { basic_salary, present_days, paid_leaves, unpaid_leaves, total_working_days } = newPayslipData;
    ...
    const hra = basic_salary * 0.20; // 20% HRA
  ...
  const handleGeneratePayslip = () => {
    ...
    alert(`Payslip generated successfully for ${computedPayslip.employee_name}!`);
  ...
  return (
    <div className="payrun-dashboard">
      <div className="dashboard-header">
        ...
        <p className="subtitle">Automatically generate payslips for all employees</p>
      </div>
        ...
        <div className="results-section">
          ...
          <div className="summary-card">
            <div className="summary-header">
              <h2>Payrun {payrunData.payrun.month} {payrunData.payrun.year}</h2>
            ...
            <div className="summary-stats">
              <div className="stat-box">
                ...
                <div className="stat-value">{payrunData.payrun.total_employees}</div>
              </div>
              <div className="stat-box">
                <div className="stat-label">Total Cost</div>
                <div className="stat-value">{formatCurrency(payrunData.payrun.total_cost)}</div>
              </div>
              <div className="stat-box">
              ...
              <table className="payslips-table">
                ...
                <tbody>
                  {payrunData.payslips.map((payslip) => (
                    <tr key={payslip.id}>
                      <td className="employee-name">{payslip.employee_name}</td>
      ...
      {!payrunData && !error && !isLoading && (
        <div className="empty-state">
          ...
          <p>Select a pay period and click "Run Payrun" to generate payslips for all employees</p>
        </div>
      )}
      ...
      {showPayslipModal && selectedPayslip && (
        <div className="modal-overlay" onClick={handleCloseModal}>
          <div className="payslip-modal payslip-modal-v2" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="print-only-content">
              <div className="print-header">
                ...
                <h2 className="print-title">Salary slip for month of {selectedEmployeeForCompute ? new Date().toLocaleDateString('en-US', { month: 'short', year: 'numeric' }) : 'Feb 2025'}</h2>
              </div>
              ...
              <div className="print-employee-details">
                <div className="detail-row">
                  ...
                  <span className="detail-value">{selectedEmployeeForCompute?.name || '[Emp Name]'}</span>
                ...
                <div className="detail-row">
                  ...
                  <span className="detail-colon">:</span>
                  <span className="detail-value">{selectedEmployeeForCompute?.id || '[Emp Code]'}</span>
                ...
                <div className="detail-row">
                  ...
                  <span className="detail-colon">:</span>
                  <span className="detail-value">1/1/2025 to 31/1/2025</span>
                </div>
                <div className="detail-row">
              ...
              <div className="print-worked-days">
                ...
                <table className="print-table">
                  ...
                  <tbody>
                    <tr>
                      <td>Attendance</td>
                      <td className="text-right">{(selectedEmployeeForCompute?.present_days || 20).toFixed(0)} Days</td>
                    </tr>
                    <tr className="total-row-print">
                      <td><strong>Total</strong></td>
                      <td className="text-right"><strong>{((selectedEmployeeForCompute?.present_days || 20) + (selectedEmployeeForCompute?.paid_leaves || 2)).toFixed(0)} Days</strong></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="print-salary-table">
                <table className="print-earnings-deductions">
                  ...
                  <tbody>
                    <tr>
                      <td>Basic Salary</td>
                      <td className="text-right">₹ {(selectedEmployeeForCompute?.basic_salary || 0).toFixed(2)}</td>
                      <td>PF Employee</td>
                      <td className="text-right">- ₹ {(selectedEmployeeForCompute?.pf_deduction || 0).toFixed(2)}</td>
                    </tr>
                    <tr>
                      <td>House Rent Allowance</td>
                      <td className="text-right">₹ {(selectedEmployeeForCompute?.hra || 0).toFixed(2)}</td>
                      <td>PF Employer</td>
                    ...
                    <tr>
                      ...
                      <td className="text-right">- ₹ {(selectedEmployeeForCompute?.tax_deduction || 0).toFixed(2)}</td>
                    </tr>
                    <tr>
                    ...
                    <tr className="gross-row">
                      ...
                      <td className="text-right"><strong>₹ {(selectedEmployeeForCompute?.gross_salary || 0).toFixed(2)}</strong></td>
                      <td></td>
                      <td></td>
                    </tr>
                  </tbody>
              ...
              <div className="print-net-payable">
                <div className="net-label">Total Net Payable (Grosss Earning - Total deductions)</div>
                <div className="net-amount">{(selectedEmployeeForCompute?.net_salary || 0).toFixed(2)}</div>
            ...
            <div className="payslip-document-v2 screen-only-content">
              ...
              <div className="payslip-description">
                <p>When a user opens any generated payslip, they can view detailed information such as working days and worked day amounts. They can also generate a new payslip or cancel, and they can print the payslip as well.</p>
              </div>
              ...
              <div className="employee-selection-section">
                ...
                <select 
                  ...
                  value={selectedEmployeeForCompute?.employee_id || selectedEmployeeForCompute?.id || ''}
              ...
              <div className="employee-header">
                <h2>{selectedEmployeeForCompute ? selectedEmployeeForCompute.employee_name : '[Employee]'}</h2>
              </div>
              ...
              <div className="employee-info-grid">
                <div className="info-row">
                  ...
                  <div className="info-value info-link">Payrun {payrunData.payrun.month} {payrunData.payrun.year}</div>
                </div>
                <div className="info-row">
              ...
              <div className="payslip-tabs">
                <button 
                  className={`tab-button ${activePayslipTab === 'worked-days' ? 'active' : ''}`}
                  onClick={() => setActivePayslipTab('worked-days')}
                >
                  Worked Days
                </button>
                <button 
                  className={`tab-button ${activePayslipTab === 'salary-computation' ? 'active' : ''}`}
              ...
              {/* Tab Content */}
              {activePayslipTab === 'worked-days' && !selectedEmployeeForCompute && (
                <div className="tab-content">
                  <div className="empty-employee-state">
                    <div className="empty-icon">👤</div>
                    <h3>No Employee Selected</h3>
                    <p>Please select an employee from the dropdown above to view their salary details</p>
                  </div>
                </div>
              )}
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="text-right">
                          {(selectedEmployeeForCompute.present_days || 0).toFixed(2)}
                          <span className="days-note"> (5 working days in week)</span>
                        </td>
                        <td className="text-right">₹ {(selectedEmployeeForCompute.basic_salary / 30 * (selectedEmployeeForCompute.present_days || 0)).toFixed(6)}</td>
                      </tr>
                      <tr>
                        <td>Paid Time off</td>
                        <td className="text-right">
                          {(selectedEmployeeForCompute.paid_leaves || 0).toFixed(2)}
                          <span className="days-note"> (2 Paid leaves/Month)</span>
                        </td>
                        <td className="text-right">₹ {(selectedEmployeeForCompute.basic_salary / 30 * (selectedEmployeeForCompute.paid_leaves || 0)).toFixed(6)}</td>
                      </tr>
                      <tr className="total-row">
                        <td colSpan="3">
                          <div className="pavan-badge">Total Worked Days</div>
                        </td>
                      </tr>
                      <tr className="total-row">
                        <td></td>
                        <td className="text-right"><strong>{((selectedEmployeeForCompute.present_days || 0) + (selectedEmployeeForCompute.paid_leaves || 0)).toFixed(2)}</strong></td>
                        <td className="text-right"><strong>₹ {(selectedEmployeeForCompute.earned_salary || 0).toFixed(2)}</strong></td>
                      </tr>
                    </tbody>
                  </table>
              ...
              {activePayslipTab === 'salary-computation' && !selectedEmployeeForCompute && (
                <div className="tab-content">
                  <div className="empty-employee-state">
                    <div className="empty-icon">👤</div>
                    <h3>No Employee Selected</h3>
                    <p>Please select an employee from the dropdown above to view their salary computation</p>
                  </div>
                </div>
              )}
                ...
                <div className="tab-content">
                  <table className="salary-computation-table">
                    ...
                    <tbody>
                      ...
                      {(selectedEmployeeForCompute.unpaid_deduction || 0) > 0 && (
                        <tr>
                          <td>Unpaid Leave Deduction</td>
                          <td className="text-right">₹ {selectedEmployeeForCompute.unpaid_deduction.toFixed(2)}</td>
                          <td className="text-right">1.00</td>
                          <td className="text-right">₹ {selectedEmployeeForCompute.unpaid_deduction.toFixed(2)}</td>
                        </tr>
                      )}
                      <tr className="subtotal-row">
                        ...
                        <td className="text-right"><strong>₹ {(selectedEmployeeForCompute.total_deductions || 0).toFixed(2)}</strong></td>
                      </tr>

                      <tr className="net-salary-row">
                        <td colSpan="3"><strong>Net Salary (Take Home)</strong></td>
                        <td className="text-right"><strong>₹ {(selectedEmployeeForCompute.net_salary || 0).toFixed(2)}</strong></td>
                      </tr>
                    </tbody>
                  </table>

                  <div className="salary-note">
                    <p><strong>Net Salary:</strong> ₹ {(selectedEmployeeForCompute.net_salary || 0).toFixed(2)}</p>
                    <p className="salary-words">In Words: {convertToWords(Math.round(selectedEmployeeForCompute.net_salary || 0))} Rupees Only</p>
                  </div>
                </div>
              )}
            </div>
      ...
      {showNewPayslipForm && (
        <div className="modal-overlay" onClick={handleCloseNewPayslipForm}>
          <div className="new-payslip-modal" onClick={(e) => e.stopPropagation()}>
            <button className="modal-close" onClick={handleCloseNewPayslipForm}>×</button>
            
            <div className="new-payslip-form">
              <h2 className="form-title">Create New Payslip</h2>
              <p className="form-subtitle">Fill in the employee details and attendance to generate a payslip</p>
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => handleNewPayslipInputChange('basic_salary', parseFloat(e.target.value))}
                      className="form-control"
                      readOnly
                    />
                  </div>
                ...
                <div className="form-grid">
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={(e) => handleNewPayslipInputChange('month', e.target.value)}
                      className="form-control"
                      required
                    >
                      {months.map(month => (
                  ...
                  <div className="form-group">
                    ...
                    <select
                      ...
                      onChange={(e) => handleNewPayslipInputChange('year', parseInt(e.target.value))}
                      className="form-control"
                      required
                    >
                      {years.map(year => (
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => handleNewPayslipInputChange('total_working_days', parseInt(e.target.value))}
                      className="form-control"
                      min="1"
                      max="31"
                    />
                ...
                <div className="form-grid">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => handleNewPayslipInputChange('present_days', parseInt(e.target.value) || 0)}
                      className="form-control"
                      min="0"
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => handleNewPayslipInputChange('paid_leaves', parseInt(e.target.value) || 0)}
                      className="form-control"
                      min="0"
                      max={newPayslipData.total_working_days}
                    />
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) => handleNewPayslipInputChange('unpaid_leaves', parseInt(e.target.value) || 0)}
                      className="form-control"
                      min="0"
                      max={newPayslipData.total_working_days}
                    />
                ...
                <div className="form-section computed-preview">
                  ...
                  <div className="preview-grid">
                    <div className="preview-item">
                      ...
                      <span className="preview-value">{formatCurrency(computedPayslip.earned_salary)}</span>
                    </div>
                    <div className="preview-item">
                      <span className="preview-label">HRA (20%):</span>
                      <span className="preview-value">{formatCurrency(computedPayslip.hra)}</span>
                    </div>
                    <div className="preview-item">
                      <span className="preview-label">Gross Salary:</span>
                      <span className="preview-value highlight">{formatCurrency(computedPayslip.gross_salary)}</span>
                    </div>
                    <div className="preview-item">
                      <span className="preview-label">PF Deduction (12%):</span>
                      <span className="preview-value deduction">-{formatCurrency(computedPayslip.pf_deduction)}</span>
                    </div>
                    <div className="preview-item">
                      <span className="preview-label">Tax Deduction:</span>
                      <span className="preview-value deduction">-{formatCurrency(computedPayslip.tax_deduction)}</span>
                    </div>
                    {computedPayslip.unpaid_deduction > 0 && (
                      <div className="preview-item">
                        <span className="preview-label">Unpaid Leave Deduction:</span>
                        <span className="preview-value deduction">-{formatCurrency(computedPayslip.unpaid_deduction)}</span>
                      </div>
                    )}
                    <div className="preview-item">
                      <span className="preview-label">Total Deductions:</span>
                      <span className="preview-value deduction">-{formatCurrency(computedPayslip.total_deductions)}</span>
                    </div>
                    <div className="preview-item net-salary-preview">
                      <span className="preview-label">Net Salary:</span>
                      <span className="preview-value">{formatCurrency(computedPayslip.net_salary)}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="form-actions">
                <button 
                  ...
                  disabled={!newPayslipData.employee_id || newPayslipData.present_days === 0}
                >
                  💰 Compute Salary
                </button>
                <button 
