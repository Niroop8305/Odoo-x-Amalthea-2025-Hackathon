-- ========================================
-- TIME OFF MANAGEMENT - DATABASE SETUP
-- Copy and paste this ENTIRE script into MySQL Workbench
-- Select all and click Execute (lightning bolt icon)
-- ========================================
...
SELECT 
    user_id,
    24.00 as paid_time_off_balance,
    7.00 as sick_time_off_balance,
...
SELECT 'Leave balances initialized:' as Info;
SELECT COUNT(*) as total_users_with_balance FROM leave_balances;

-- Show sample balances
SELECT 
    lb.user_id,
    CONCAT(ep.first_name, ' ', COALESCE(ep.last_name, '')) as employee_name,
    lb.paid_time_off_balance,
    lb.sick_time_off_balance,
    lb.year
FROM leave_balances lb
LEFT JOIN employee_profiles ep ON lb.user_id = ep.user_id
LIMIT 5;

SELECT '✅ Setup Complete! You can now use the Time Off feature.' as FinalStatus;
