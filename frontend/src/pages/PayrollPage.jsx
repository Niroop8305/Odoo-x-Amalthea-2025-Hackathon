      ...
      <main className="dashboard-main">
        ...
        <div className="payroll-page">
          ...
          <div className="payroll-header">
            ...
            <button className="tab-btn" onClick={() => navigate("/payrun")}>
              Payrun
            </button>
          </div>
                    ...
                    <div className="chart-bars">
                      <div className="bar-group">
                        <div className="bar-container">
                          <div
                            className="bar employer-bar"
                            style={{
                              height:
                                employerCostView === "monthly" ? "60%" : "75%",
                            }}
                          ></div>
                        </div>
                      ...
                      <div className="bar-group">
                        <div className="bar-container">
                          <div
                            ...
                            style={{
                              height:
                                employerCostView === "monthly" ? "75%" : "65%",
                            }}
                          ></div>
                        </div>
                      ...
                      <div className="bar-group">
                        <div className="bar-container">
                          <div
                            ...
                            style={{
                              height:
                                employerCostView === "monthly" ? "90%" : "85%",
                            }}
                          ></div>
                        </div>
                      ...
                      <div className="bar-group">
                        <div className="bar-container">
                          <div
                            ...
                            style={{
                              height:
                                employeeCountView === "monthly" ? "55%" : "70%",
                            }}
                          ></div>
                        </div>
                        <span className="bar-label">Jan 2025</span>
                      ...
                      <div className="bar-group">
                        <div className="bar-container">
                          <div
                            ...
                            style={{
                              height:
                                employeeCountView === "monthly" ? "70%" : "60%",
                            }}
                          ></div>
                        </div>
                        <span className="bar-label">Feb 2025</span>
                      ...
                      <div className="bar-group">
                        <div className="bar-container">
                          <div
                            ...
                            style={{
                              height:
                                employeeCountView === "monthly" ? "85%" : "80%",
                            }}
                          ></div>
                        </div>
                        <span className="bar-label">Mar 2025</span>
